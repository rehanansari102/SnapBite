...
export const metadata = { title: 'Incoming Orders — SnapBite' }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-0.5">Manage and update orders for your restaurants</p>
      </div>
      <RestaurantOrdersClient restaurants={restaurants} />
    </div>
  )
}
